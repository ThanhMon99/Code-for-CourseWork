<head>
  ...
  <title>Personal Tutor System</title>
   ...
   <!-- Favicons -->
 <link rel="apple-touch-icon" sizes="180x180" href="Form/img/apple-touch-icon.png">
<link rel="icon" type="image/png" sizes="32x32" href="Form/img/favicon-32x32.png">
<link rel="icon" type="image/png" sizes="16x16" href="Form/img/favicon-16x16.png">
